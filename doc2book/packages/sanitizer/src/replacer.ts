...
import type { SanitizeResult, SanitizeEntityType } from '@doc2book/shared'
import type { DetectionResult, SanitizeOptions } from './types'

export class ContentReplacer {
  private defaultReplacements: Record<SanitizeEntityType, string> = {
    person: '某人',
    brand: '某品牌',
    company: '某公司',
    product: '某产品',
  ...
  replace(
    text: string,
    entities: NonNullable<DetectionResult['entities']>,
